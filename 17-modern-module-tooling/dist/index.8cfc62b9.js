...
/**
 * Top level Await
 */ /** Stops the entire program and blocks the program*/ // console.log(`Start fetching`)
// const res = await fetch(`https://jsonplaceholder.typicode.com/posts`);
// const data = await res.json();
// console.log(data);
// console.log(`Something`);
/** Example */ // const getLastPost = async function() {
//     const res = await fetch(`https://jsonplaceholder.typicode.com/posts`);
//     const data = await res.json();
//     console.log(data);
...
console.log(stateDeepClone); // if (module.hot) {
 //   module.hot.accept();
 // }
...
/**Blocking Code */ /** Top level await blocks module and the module its exporting to */ // console.log(`Start fetching users`);
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gAoaA","6rimH"], "6rimH", "parcelRequire72c1")
